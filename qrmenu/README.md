...
Всё это настраивается в «Настройках» → «Главный экран гостя»: слоган (на всех языках), фоновое фото, название и пароль Wi‑Fi (пустое название — блок скрыт), часы работы по дням недели с выходными (выключено — блок скрыт). Если все дни одинаковые, гость видит «11:00 – 23:00 · Ежедневно», иначе — часы на сегодня.
